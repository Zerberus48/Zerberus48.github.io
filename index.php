            ...
            <div id="container">
              <div id="login">
                <form action="iniciar_sesion.php" method="POST">
                  ...
                  <div class="form_group show-hide"> 
                  ...
                  <span class="form_line"></span>  
                  <div class="box"><ion-icon name="eye-outline" id="hide" onclick="change()"></ion-icon><ion-icon id="show" name="eye-off-outline" onclick="change()"></ion-icon></div>
                  </div></div>
