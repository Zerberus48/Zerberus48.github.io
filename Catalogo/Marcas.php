...
<html lang="es">
    ...
    <body>
      ...
      <article>
        <div class="topbar">
          <h2>Marcas</h2>
          <button class="nuevo" id="btn-Abrir-Window"><i class='bx bx-plus-circle'></i>Nueva Marca</button>
        </div>
        <div class="tmarcas">
          <table>
            <tr>
    ...
    <!-- Ventana Nueva Marca -->
        ...
        <div class="popup" id="popup">
            ...
            <form class="form" action="../Registrar-Marcas.php" method="POST">
                <h2>Nueva Marca</h2>
                <div class="form_container">
                    <div class="form_group">
                        <input type="text" id="marca" class="form_input" placeholder=" " name="marca" required>
